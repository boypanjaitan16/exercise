                        ...
                        <form onSubmit={handleSubmit(updatePassword)}>
                            ...
                            <FormGroup className='mb-5'>
                                <TextField
                                    fullWidth
                                    inputRef={register({
                                        required : user.has_password ? 'Current password is required' : false,
                                    })}
                                    error={!!errors.current}
                                    helperText={user.has_password ? errors.password_current?.message : 'Please leave this empty if you don\'t have password yet'}
